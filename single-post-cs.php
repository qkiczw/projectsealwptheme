        ...
        <header class="header header-subpage">
            ...
            <div class="header__hero">
                <div class="header__hero__content">
                    <h1 class="header__hero__content__title">Zkontrolujte, co se stalo nebo stane</h1>
                    ...
                    <div class="col-lg-12 post-full">
                        <article>
                            <h2><?php the_title(); ?></h2>
                                ...
                                <?php the_content(); ?>
                            <p>
                                <a href="https://sealproject.eu/cs/category/news-cs/"><strong>&laquo Zadní</strong></a>
                            </p>
                        </article>
                    </div>
                </div>
