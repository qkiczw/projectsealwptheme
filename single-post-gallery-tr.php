        ...
        <header class="header header-subpage">
            ...
            <div class="header__hero">
                <div class="header__hero__content">
                    <h1 class="header__hero__content__title">Toplantılarımızdan ve gezilerimizden fotoğraflar</h1>
                    ...
                    <div class="col-lg-12 post-gallery-full">
                        <article>
                            ...
                            <p class="post-gallery-backBtn">
                                <a href="https://sealproject.eu/tr/category/galleries-tr/"><strong>&laquo Geri</strong></a>
                            </p>
                        </article>
                    </div>
                </div>
