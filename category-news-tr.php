        ...
        <header class="header header-subpage">
            ...
            <div class="header__hero">
                <div class="header__hero__content">
                    <h1 class="header__hero__content__title">Ne olduğunu veya ne olacağını kontrol et</h1>
                    ...
                    <article class="post">
                        ...
                        <div class="col-sm-12 col-lg-9 post__content">
                            ...
                            <div class="post__content_full-view">
                                <a href="<?php the_permalink() ?>" class="post__btn__more">Daha  &raquo</a>
                            </div>
                        </div>
                    </article>
                <?php endwhile; ?>     
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 pagination text-left">
                        <?php next_posts_link('&#171; eski postalar'); ?>
                    </div>
                    <div class="col-6 pagination text-right">
                        <?php previous_posts_link('en yeni paylaşımlar &#187;'); ?> 
                    </div>
                </div>
            </div>
        </main>
