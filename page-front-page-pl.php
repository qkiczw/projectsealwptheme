                ...
                <div class="row hero">
                    <div class="col-md-6 hero__text">
                        ...
                        <div class="hero__text__content">                           
                            ...
                            <a class="btn--grey" href="#about-us">Zacznij przygodę</a>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<main>
                ...
                <div class="row about-us__content"> <!-- Section content  -->
                    ...
                    <div class="col-md-7">
                        <div class="about-us__short-info">
                            ...
                            <a href="http://qki.cba.pl/seal/en/o-nas-en/" class=" btn--grey">Więcej o nas</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="partners__row__partner">
                            ...
                            <div class="partners__row_partner__link-area">
                                <div class="partners__row_partner__link-area_title">Linki</div>
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-6 col-lg-4 fp-galleries__content__items">
                    <div class="fp-galleries__content__items__item">
                        ...
                        <div class="fp-galleries__content__items__item__desc">
                            <div class="fp-galleries__content__items__item__desc__title">tytuł</div>
                            <hr />
            ...
            <div class="row see-more-galleries">
                <a href="http://qki.cba.pl/seal/pl/galerie/" class="btn--white">Zobacz więcej galerii</a>
            </div> 
        </div> 
        </section> 
    </main>
